...
def writeHTMLhead(state_file, state_name, css):
    ...
    state_file.write("<h1>CS Education Metrics Scorecard for " + state_name + " (2021)</h1>\n")
    state_file.write("<p>For more information on this scorecard, visit <br><a href='https://cranidores.org/cs-education-analytics/state-specific-computer-science-education-scorecards-2021/'>https://cranidores.org/cs-education-analytics/state-specific-computer-science-education-scorecards-2021/</a></p>\n")
...
# Read data files      
dfSchool = pd.read_csv('SchoolLevelDataForExport.csv')
dfAPState = pd.read_csv('APCSByState.csv')
dfStudent = pd.read_csv('StudentComparisonMetrics.csv')
